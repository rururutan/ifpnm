...
**
**  Public domain by MIYASAKA Masaru (Apr 16, 2006)
*/
...
#define SPI_SUPPORT_SPIGETBYTE		/* SpiGetByte() を利用可能にする */
...
#define SPI_SUPPORT_EOFFLAG			/* EOF を表すフラグを利用可能にする */
...
#define SPI_SUPPORT_SPIREALLOC		/* SpiReAllocBuffer() を利用可能にする */

	/* Overrides (spiio.c) */
#define SPI_BUFSIZ		(256*1024)		/* 読み込みバッファサイズ */
#define SPI_EOF			(~0xFF|'0')		/* End Of File を表す値 */
